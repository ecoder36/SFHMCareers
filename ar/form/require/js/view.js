var TableDatatablesButtons = function () {
    ...
    var initTable1 = function () {
        ...
        var oTable = table.dataTable({
            ...
            buttons: [
                { extend: 'print', className: 'btn dark btn-outline', text: 'طباعة', },
                { extend: 'copy', className: 'btn red btn-outline' , text: 'نسخ'},
                { extend: 'pdf', className: 'btn green btn-outline' , text: 'PDF'  },
                { extend: 'excel', className: 'btn yellow btn-outline ' , text: 'إكسل' },
