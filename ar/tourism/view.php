                            ...
                            <div class="row">
                                <div class="col-md-12">
                                     <?php
                                        ...
                                        <button class="close" data-close="alert"></button><strong>Error! </strong> Wrong Password </div>';}
                                        
                                         if   (isset($_GET['ddel'] )  )  {echo '<div class="alert alert-success ">
                                        <button class="close" data-close="alert"></button><strong>SUCCESS! </strong> deleted successfully </div>';}
                                    ?>
