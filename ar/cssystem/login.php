...
if(isset($_POST['username']) && (isset($_POST['password'])))
{
        ...
        header("Location: ?user=يوجد خطأ في اسم المستخدم.&uname=$uname");
        ...
        if($user->eid == '1'){
            ...
            header("Location: ?password=يوجد خطأ في كلمة المرور &uname=$uname");
            ...
            header("Location: ?status=لا يمكنك تسجيل الدخول للنظام &uname=$uname");
        }
...
<?php $enlink = "../../en/cssystem/login.php" ?>
        <?php $aclogin="active" ?>
                                     ...
                                     <div class="portlet light portlet-fit portlet-form ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-yellow sbold uppercase">تسجيل الدخول</span>
                                            </div>
                                            <div class="actions">
                                        ...
                                        <div class="portlet-body">
                                         ...
                                         <div class="form-body">
                                            <div class="alert alert-danger display-hide">
                                                <button class="close" data-close="alert"></button> <strong>يوجد خطأ في البيانات يرجى التأكد من الخطأ</strong> </div>
                                                   <?php    if(isset($_GET['user'])){echo '<div class="alert alert-danger ">
                                                    <button class="close" data-close="alert"></button><strong>'.$_GET['user'].' </strong> </div>';}
                                                      if(isset($_GET['password'])){echo ' <div class="alert alert-danger ">
                                                    <button class="close" data-close="alert"></button><strong>'.$_GET['password'].'</strong> </div>';}
                                                    if(isset($_GET['status'])){echo '<div class="alert alert-danger ">
                                                    <button class="close" data-close="alert"></button><strong>'.$_GET['status'].'</strong> </div>';}?>
                                                    ...
                                                    <div class="form-actions">
                                                        <div class="row">
                                                            <div class="col-md-offset-3 col-md-9">
                                                                <button type="submit" class="btn yellow" >تسجيل الدخول</button>
                                                            </div>
                                                        </div>
                                                    </div> 
                                            </form> 
