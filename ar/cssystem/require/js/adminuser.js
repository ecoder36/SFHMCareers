var TableDatatablesEditable = function () {
    ...
    var handleTable = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            jqTds[4].innerHTML = '<select name="perm" type="text" class="copy4 form-control input-small" ><option >' + aData[4] + '</option><option >مستخدم</option><option >مسؤول</option></select>';
          //  jqTds[4].innerHTML = '<input name="isadmin" type="text" class=" copy4 form-control input-small" value="' + aData[4] + '">';

            jqTds[5].innerHTML='<form clas="edit" action="?id='+aData[0]+'&859" method="post" ><input type="hidden" class="copy1c" name="name" value="'+aData[1]+'"><input type="hidden" class="copy2c" name="uname" value="'+aData[2]+'"><input type="hidden" class="copy3c" name="password" value="'+aData[3]+'"><input type="hidden" class="copy4c" name="perm" value="'+aData[4]+'"><button type="submit" onclick="$(this).parent(\'form\').submit();" class="btn btn-primary">حفظ</button></form>',
            $(".copy1").keyup(function(){ $(".copy1c").val($(this).val()); });
            $(".copy2").keyup(function(){ $(".copy2c").val($(this).val()); });
            $(".copy3").keyup(function(){ $(".copy3c").val($(this).val()); });
            $(".copy4").on("change", function (){$(".copy4c").val($(this).find("option:selected").text());});
          //  $(".copy4").keyup(function(){ $(".copy4").val($(this).val()); });
            jqTds[6].innerHTML = '<a class="cancel" href="">إلغاء</a>';
        }
  ...
  "language": {
                ...
                "infoFiltered": "(فلترة من أصل _MAX_  )",
