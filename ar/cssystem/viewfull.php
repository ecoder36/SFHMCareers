...
if($_SESSION['user_info_2']->isadmin == 1){
     ...
     $result = info_delete($_id);
          if($result){
                header("Location: view3.php?sitedel= تم حذف معلومات $site بنجاح ");
            } 
     }
         if(isset($_POST['id'])){
            ...
            if($result){
                $usite = "تم تحديث المعلومات بنجاح" ;
                $pid = $_POST['id'] ;
...
//die($_GET['del']);
            ...
            if($_del == 0)
             ...
             tinyf_db_close();
             if($resultd){
                 $file = "../../en/cssystem/file/".$_GET['file'];
                      unlink($file);
...
<?php $enlink = "../../en/cssystem/viewfull.php?id=".$_GET['id']."" ?>
        <?php $view2="active" ?>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <div class="container">
                        <!-- BEGIN PAGE BREADCRUMBS -->
                         <ul class="page-breadcrumb breadcrumb">
                            <li>
                                <a href="view3.php">عرض الطلبات </a>
                                <i class="fa fa-circle"></i>
                            </li>
                          
                            <li>
                                <span><?php echo $user->site ?></span>
                            </li>
                        </ul>
                    ...
                    <button class="close" data-close="alert"></button><strong>'.$_GET['siteupdate'].'</strong></div>';} ?>
                                                    ...
                                                    <div class="portlet box green" style="border:1px solid #caa88e;">
                                                        <div class="portlet-title" style="background-color:#caa88e;">
                                                            ...
                                                            <?php if($_SESSION['user_info_2']->isadmin == 1){ ?>
                                                                ...
                                                                <a class="btn btn-circle btn-icon-only btn-default tooltips" title="تعديل" data-toggle="modal" href="#cedit_modal">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a class="btn btn-circle btn-icon-only btn-default tooltips" title="حذف" href="?id=<?php echo $user->id ?>&del=d&site=<?php echo $user->site ?>" onclick="return confirm(' هل أنت متأكد من حذف معلومات  (<?php echo $user->site ?>) ?')">
                                                        ...
                                                        <div class="portlet-body">
                                                        <table class="table table-striped table-hover table-bordered text-left" dir="ltr"  id="sample_1">
                                                           <thead >
                                                                <tr>
                                                                    <th >المعلومات</th>
                                                                     <th >التصنيف</th>
                                                            ...
                                                            <tbody dir="ltr">
                                                                <tr > 
                                                                <td><?php echo $user->region." \ ".$user->zone ?></td>
                                                                <td class='bold theme-font' >المنطقة / المدينة</td>
                                                                </tr>
                                                                 <tr>   
                                                                 <td><?php echo $user->site ?></td>
                                                                  <td class='bold theme-font' >اسم الموقع</d>
                                                                </tr>
                                                                <td><?php echo $user->letternumber ?></td>
                                                                  <td class='bold theme-font' >     رقم الخطاب المسند إليه </d>
                                                                </tr>
                                                                <td><?php echo $user->letterdate ?></td>
                                                                  <td class='bold theme-font' >  تاريخ الخطاب </d>
                                                                </tr>
                                                                <td><?php echo $user->sitename ?></td>
                                                                  <td class='bold theme-font' >    الجهة الطالبة  </d>
                                                                </tr>
                                                                <tr>    
                                                                <?php 
                                                                if($user->btype == "Governmental"){
                                                                    $btype = "حكومي";
                                                                }
                                                                if($user->btype == "Rented"){
                                                                    $btype = "مستأجر";
                                                                }
                                                                
                                                                ?>
                                                                  <td><?php echo $btype ?></td>
                                                                  <td class='bold theme-font' >نوع المبنى</td>
                                                                </tr>
                                                                <tr>   
                                                                  <td><?php echo $user->ficameras ?></td>
                                                                  <td class='bold theme-font' >الكاميرات الداخلية الثابتة</td>
                                                                </tr>
                                                                <tr>   
                                                                  <td><?php echo $user->micameras ?></td>
                                                                  <td class='bold theme-font' >الكاميرات الداخلية المتحركة</td>
                                                                </tr>
                                                                <tr> 
                                                                  <td><?php echo $user->fecameras ?></td>
                                                                  <td class='bold theme-font' >الكاميرات الخارجية الثابتة</td>
                                                                </tr>
                                                                <tr>   
                                                                  <td><?php echo $user->mecameras ?></td>
                                                                  <td class='bold theme-font' >الكاميرات الخارجية المتحركة</td>
                                                                </tr>
                                                                <tr>  
                                                                  <td><?php echo $user->dvr ?></td>
                                                                  <td class='bold theme-font' >DVR</td>
                                                                </tr>
                                                                <tr>   
                                                                  <td><?php echo $user->nvr ?></td>
                                                                  <td class='bold theme-font' >NVR</td>
                                                                </tr>
                                                                <tr>    
                                                                  <td><?php echo $user->pc ?></td>
                                                                  <td class='bold theme-font' >أجهزة الحاسب</td>
                                                                </tr>
                                                                <tr>    
                                                                  <td><?php echo $user->controld ?></td>
                                                                  <td class='bold theme-font' >أجهزة التحكم</td>
                                                                </tr>
                                                                <tr>   
                                                                  <td><?php echo $user->screens ?></td>
                                                                  <td class='bold theme-font' >الشاشات</td>
                                                                </tr>
                                                                <tr>   
                                                                  <td><?php echo $user->switch ?></td>
                                                                  <td class='bold theme-font' >Switch</td>
                                                                </tr>
                                                                <tr>    
                                                                  <td><?php echo $user->ups ?></td>
                                                                  <td class='bold theme-font' >UPS</td>
                                                                </tr>
                                                                <tr>    
                                                                  <td><?php echo $user->note ?></td>
                                                                  <td class='bold theme-font' >ملاحظات</td>
                                                                </tr>
                                                                <tr>   
                                                                ...
                                                                <tr>   
                                                                  ...
                                                                  <td class='' >اسم منشئ الطلب  <?php echo $username ?></td>
                                                                </tr>
                                                                  <?php if($uusername != NULL){ ?>
                                                                  <tr>    
                                                                  <td> <?php echo $user->udate ?></td>
                                                                  <td class='' > آخر تحديث : <?php echo $uusername ?> حدث الطلب </td>
                                                                  </tr>
                                                                  <?php } else{ } ?>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title"> تعديل معلومات الطلب </h4>
                                                </div>
                                                <div class="modal-body">
                                                    <form action="?id=<?php echo $user->id ?>&eregion=e&usite=<?php echo $user->site ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <label class="control-label col-md-5"> الكاميرات الداخلية الثابتة <span class="required"> * </span></label>
                                                        <div class="col-md-5">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-5">الكاميرات الداخلية المتحركة <span class="required"> * </span></label>
                                                        <div class="col-md-5">
                                                            <input name="micameras" type="text" id="mask_number2" class="form-control" value="<?php echo $user->micameras ?>" /> </div>
                                                    </div>
                                               
                                                    <div class="form-group">
                                                        <label class="control-label col-md-5"> الكاميرات الخارجية الثابتة <span class="required"> * </span></label>
                                                        <div class="col-md-5">
                                                            <input name="fecameras" type="text" class="mask_number form-control" value="<?php echo $user->fecameras ?>" /> </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-5">الكاميرات الخارجية المتحركة <span class="required"> * </span></label>
                                                        <div class="col-md-5">
                                                     ...
                                                     <div class="form-group">
                                                        <label class="control-label col-md-5"> أجهزة الحاسب <span class="required"> * </span></label>
                                                        <div class="col-md-5">
                                                            <input name="pc" type="text" class="mask_number form-control" value="<?php echo $user->pc ?>" /> </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-5"> أجهزة التحكم <span class="required"> * </span></label>
                                                        <div class="col-md-5">
                                                            <input name="controld" type="text" class="mask_number form-control" value="<?php echo $user->controld ?>" /> </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-5" style="font-family: 'stoor.ttf';">الشاشات <span class="required"> * </span></label>
                                                        <div class="col-md-5">
                                                    ...
                                                    <div class="form-group">
                                                     ...
                                                     <div class="form-group">
                                                        <label class="control-label col-md-5"  style="font-family: 'UniversNextArabic-Regular.ttf';">ملاحظات <span class="required">  </span></label>
                                                        <div class="col-md-5">
                                                            <textarea placeholder="يمكنك فقط كتابة 225 حرف " maxlength="225" type="text" rows="5" name="note" class="form-control" ><?php echo $user->note ?></textarea>
                                                        </div>
                                                    </div>
                    ...
                    <button class="close" data-close="alert"></button><strong>Success! </strong>'.$_GET['siteupdate'].'</div>';} ?>
                                                ...
                                                <div class="table-container">
                                                    <div class="portlet box green" style="border:1px solid #caa88e;">
                                                        <div class="portlet-title" style="background-color:#caa88e;">
                                                            <div class="caption">
                                                                <i class="fa fa-geara"></i>المرفقات
                                     ...
                                     <div class="cbp-item graphic">
                                        <div class="cbp-caption">
                                            <div class="cbp-caption-defaultWrap">
                                                <img src="../../en/cssystem/file/<?php echo $file->fileLink ?>" alt="Image not found" style="width:283px;height:283px;" onerror="this.src='NoImage.jpg';"></div>
                                            <div class="cbp-caption-activeWrap">
                                                <div class="cbp-l-caption-alignCenter">
                                                    <div class="cbp-l-caption-body">
                                                        <a href="?imgdel=<?php echo $file->id ?>&id=<?php echo $user->id ?>&file=<?php echo $file->fileLink ?>&5945" 
                                                         onclick="return confirm('Are you sure to delete (<?php echo $file->fileName ?>) file  ?')"  class="cbp-l-caption-buttonLeft btn red uppercase btn red uppercase" rel="nofollow">حذف</a>
                                                        
                                                        
                                                        
                                                        <a href="../../en/cssystem/file/<?php echo $file->fileLink ?>" class="cbp-lightbox cbp-l-caption-buttonRight    btn green uppercase" data-title="Filename<br><?php echo $file->fileName ?>">عرض الصورة</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="cbp-l-grid-projects-title uppercase text-center uppercase text-center"><?php echo substr($file->fileName,0,-4) ?></div>
                                        <a href="../../en/cssystem/file/<?php echo $file->fileLink ?>" target="_blank"><div class="cbp-l-grid-projects-desc uppercase text-center uppercase text-center">
                                    ...
                                    <div id="attadd_modal" class="modal fade" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                                    <h4 class="modal-title">إضافة المزيد  </h4>
                                                </div>
                                                <div class="modal-body">
                                                    <form action="?id=<?php echo $user->id ?>&addpic=e ?>" class="form-horizontal" method="post" enctype="multipart/form-data">   
                                                        <input type="hidden" name="id" class="form-control" value="<?php echo  @$user->id  ; ?>" /> 
                                                                 <div class="form-group">
                                                                    <label class="control-label col-md-4">المرفقات</label>
                                                                    <div class="col-md-7">
                                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                            <span class="btn green btn-file">
                                                                                <span class="fileinput-new"> إختيار الملف </span>
