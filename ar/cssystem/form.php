            ...
            if ($ucount != 0)
                   {
                       ...
                       header("Location: ?error=123&id=$requestchek->id&site=$site&region=$region&zone=$zone");
            		}  else 
                ...
                if(move_uploaded_file($tmp_name, "../../en/cssystem/file/".$file_name)){ $file = $file_name; } else {  $file = 'null' ; }
                ...
                if(move_uploaded_file($tmp_name, "../../en/cssystem/file/".$file_name2)){ $file2 = $file_name2; } else {  $file2 = 'null' ; }
                ...
                if(move_uploaded_file($tmp_name, "../../en/cssystem/file/".$file_name3)){ $file3 = $file_name3; } else {  $file3 = 'null' ; }
                ...
                if(move_uploaded_file($tmp_name, "../../en/cssystem/file/".$file_name4)){ $file4 = $file_name4; } else {  $file4 = 'null' ; }
                ...
                if(move_uploaded_file($tmp_name, "../../en/cssystem/file/".$file_name5)){ $file5 = $file_name5; } else {  $file5 = 'null' ; }
                ...
                if(move_uploaded_file($tmp_name, "../../en/cssystem/file/".$file_name6)){ $file6 = $file_name6; } else {  $file6 = 'null' ; }
                ...
                if(move_uploaded_file($tmp_name, "../../en/cssystem/file/".$file_name7)){ $file7 = $file_name7; } else {  $file7 = 'null' ; }
                ...
                if(move_uploaded_file($tmp_name, "../../en/cssystem/file/".$file_name8)){ $file8 = $file_name8; } else {  $file8 = 'null' ; }
                ...
                if(move_uploaded_file($tmp_name, "../../en/cssystem/file/".$file_name9)){ $file9 = $file_name9; } else {  $file9 = 'null' ; }
                ...
                if(move_uploaded_file($tmp_name, "../../en/cssystem/file/".$file_name10)){ $file10 = $file_name10; } else {  $file10 = 'null' ; }
...
<html lang="en" dir="rtl">
    ...
    <head>
        ...
        <link href="../assets/global/plugins/bootstrap-markdown/css/bootstrap-markdown.min.css" rel="stylesheet" type="text/css" />
           ...
           <script src="../../en/cssystem/require/js/jquery.min.js"></script>
...
$("#suggesstion-box").hide();
        ...
        <?php $enlink = "../../en/cssystem/form.php" ?>
        <?php $newreq="active" ?>
                                    ...
                                    <div class="portlet light portlet-fit portlet-form ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-dark sbold uppercase">النموذج </span>
                                            </div>
                                        </div>
                                            ...
                                            <form method="post" id="form_sample_3" class="form-horizontal" enctype="multipart/form-data">
                                                <div class="form-body">
                                                    <div class="alert alert-danger display-hide">
                                                        <button class="close" data-close="alert"></button> يوجد بعض الأخطاء  </div>
                                                     <?php  if(isset($_GET['done'])){echo ' <div class="alert alert-success ">
                                                <button class="close" data-close="alert"></button><strong>تم إضافة المعلومات بنجاح</strong></div>';}?>
                                                     <?php if(isset($_GET['error'])) {
                                            		echo '<div class="alert alert-danger"><button class="close" data-close="alert"></button><strong> خطأ : لا يمكن إضافة المعلومات لهذا الموقع  - '.@$_GET['region'].'  '.@$_GET['zone'].'  '.@$_GET['site'].'   -   لأنه تمت الإضافة مسبقا</strong></div>';
                                            		} ?>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">المنطقة
...
?>
                                                    ...
                                                    <div class="form-group select2">
                                                        <label class="control-label col-md-3">المدينة <span class="required"> * </span></label>
                                                        <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3"> اسم الموقع <span class="required"> * </span></label>
                                                        <div class="col-md-4">
                                                     ...
                                                     <div class="form-group">
                                                        <label class="control-label col-md-3"> رقم الخطاب المسند إليه<span class="required"> * </span></label>
                                                        <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">تاريخ الخطاب<span class="required"> * </span></label>
                                                        <div class="col-md-4">
                                                            <input name="letterdate" id="mask_date" placeholder="" type="text" class="form-control" value="<?php echo @$_GET['letterdate'] ?>" />
                                                            <span class="help-block"></span>
                                                            </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">   الجهة الطالبة <span class="required"> * </span></label>
                                                        <div class="col-md-4">
                                                    ...
                                                    <div class="form-group form-md-radios">
                                                        <label class="col-md-3 control-label font-dark" for="form_control_1"> نوع المبنى <span class="required"> * </span></label>
                                                        <div class="col-md-9">
                                                            <div class="md-radio-inline">
                                                                <div class="md-radio">
                                                                    ...
                                                                    <label for="checkbox1_8">
                                                                        ...
                                                                        <span class="box"></span> حكومي </label>
                                                                </div>
                                                                <div class="md-radio">
                                                                    ...
                                                                    <label for="checkbox1_9">
                                                                        <span></span>
                                                                        <span class="check"></span>
                                                                        <span class="box"></span> مستأجر </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3"> الكاميرات الداخلية الثابتة <span class="required"> * </span></label>
                                                        <div class="col-md-3">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">الكاميرات الداخلية المتحركة <span class="required"> * </span></label>
                                                        <div class="col-md-3">
                                                            <input name="micameras" type="text" id="mask_number2" class="form-control" value="<?php echo @$_GET['micameras'] ?>" /> </div>
                                                    </div>
                                               
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">الكاميرات الخارجية الثابتة<span class="required"> * </span></label>
                                                        <div class="col-md-3">
                                                            <input name="fecameras" type="text" class="mask_number form-control" value="<?php echo @$_GET['fecameras'] ?>" /> </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">الكاميرات الخارجية المتحركة<span class="required"> * </span></label>
                                                        <div class="col-md-3">
                                                     ...
                                                     <div class="form-group">
                                                        <label class="control-label col-md-3"> أجهزة الحاسب <span class="required"> * </span></label>
                                                        <div class="col-md-3">
                                                            <input name="pc" type="text" class="mask_number form-control" value="<?php echo @$_GET['pc'] ?>" /> </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">أجهزة التحكم<span class="required"> * </span></label>
                                                        <div class="col-md-3">
                                                            <input name="controld" type="text" class="mask_number form-control" value="<?php echo @$_GET['controld'] ?>" /> </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3"> الشاشات <span class="required"> * </span></label>
                                                        <div class="col-md-3">
                                                            <input name="screens" type="text" class="mask_number form-control" value="<?php echo @$_GET['screens'] ?>" /> </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3"> السويتشات <span class="required"> * </span></label>
                                                        <div class="col-md-3">
...
<div class="form-group">
                                                        <label class="control-label col-md-3">مرفقات</label>
                                                        ...
                                                        <div class="col-md-4">
                                                          ...
                                                          <div class="col-md-4">
                                                            ...
                                                            <button class="col-md-2 btn green" id="add2" type="button"> <i class="fa fa-plus"></i></button> 
                                                            <button class="btn green" id="add3" type="button" style="display: none;"> <i class="fa fa-plus"></i></button> 
                                                            <button class="btn green" id="add4" type="button" style="display: none;"> <i class="fa fa-plus"></i></button> 
                                                            <button class="btn green" id="add5" type="button" style="display: none;"> <i class="fa fa-plus"></i></button> 
                                                            <button class="btn green" id="add6" type="button" style="display: none;"><i class="fa fa-plus"></i></button> 
                                                            <button class="btn green" id="add7" type="button" style="display: none;"> <i class="fa fa-plus"></i></button> 
                                                            <button class="btn green" id="add8" type="button" style="display: none;"> <i class="fa fa-plus"></i></button> 
                                                            <button class="btn green" id="add9" type="button" style="display: none;"><i class="fa fa-plus"></i></button> 
                                                            <button class="btn green" id="add10" type="button" style="display: none;"><i class="fa fa-plus"></i></button> 
                                                ...
                                                <div class="form-actions">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            ...
                                                            <button type="reset" class="btn help" value="Reset" onclick="return window.location.href = 'form.php'"> إلغاء </button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
