...
if(isset($_POST['username']) && (isset($_POST['password'])))
{
        ...
        $user =  rapp_get_by_idnumber($_POST['username']);
        ...
        if($_SESSION['user_info'] != false ){
         header('Location: userprofile.php?idnumber='.$_SESSION['user_info']->idnumber.'');
        }else
                ...
                <div class="page-head">
                    <div class="container-fluid">
                        ...
                        <div class="page-title">
                            <h1>تسجيل الدخول 
                                <small>نموذج تسجيل الدخول لملف التقديم</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                    ...
                    <div class="container">
                        ...
                        <ul class="page-breadcrumb breadcrumb">
                         ...
                         <div class="alert alert-success ">
                             <button class="close" data-close="alert"></button> <br>
                        
                             <table class="" id="sample_2">
                                 <thead>
                                     <td ><p> </p></td>
                                 </thead>
                                 <tbody>
                                 <tr>
                                     <td>الرقم المرجعي :<strong><?php echo @$_GET[pass] ; ?></strong></td>
                                 </tr>
                                 
                                  <tr>
                                     <td>يمكنك تسجيل الدخول بواسطة رقم الهوية والرقم السري لإكمال ملف التقديم</td>
                                 </tr>
                                 <tr>
                                     <td>رقم هويتك : <strong><?php echo @$_GET[idnumber] ; ?> </strong> </td>
                                 </tr>
                                 <tr>
                                     <td>الرقم السري : <strong><?php echo @$_GET[pass] ; ?></strong></td>
                                 </tr></tbody>
                             </table>   
                         ...
                         <div class="alert alert-danger ">
                                                        <button class="close" data-close="alert"></button> يوجد لك ملف هنا يرجى تسجيل الدخول برقم الهوية وكلمة المرور لمشاهدة ملفك  </div>
                          <?php  } ?>
                                     ...
                                     <div class="portlet light portlet-fit portlet-form ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-green sbold uppercase">تسجيل الدخول </span>
                                            </div>
                                            <div class="actions">
                                        ...
                                        <div class="portlet-body">
                                         ...
                                         <div class="form-body">
                                            <div class="alert alert-danger display-hide">
                                                <button class="close" data-close="alert"></button> يوجد خطأ في النموذج يرجى مراجعته . </div>
                                            ...
                                            <form method="post"  action="" id="form_sample_3" class="form-horizontal">
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">رقم الهوية
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="username" class="form-control" placeholder="رقم الهوية" > </div>
                                                                <span class="help-block"> أدخل رقم الهوية </span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="password" name="password" class="form-control" placeholder="كلمة المرور" > </div>
                                                                <span class="help-block">أدخل كلمة المرور </span>
                                                        </div>
                                                    </div>
