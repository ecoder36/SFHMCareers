                    ...
                    <div class="container">
                        ...
                        <ul class="page-breadcrumb breadcrumb">
                         ...
                         <div class="alert alert-danger ">
                                                        <button class="close" data-close="alert"></button> you can login by your idnumber and password to complete your CV <br>id number : <?php echo $_GET[idnumber] ; ?> <br> password : <?php echo $_GET[pass] ; ?> </div>
                          <?php  } ?>
                          <?php    if(isset($_GET['iderror'])){ ?>
                         <div class="alert alert-danger ">
                                                        <button class="close" data-close="alert"></button> yuo have CV here you can login by your idnumber and your password to view and edit your CV  </div>
                          <?php  } ?>
