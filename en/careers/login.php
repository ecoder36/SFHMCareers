                        ...
                        <ul class="page-breadcrumb breadcrumb">
                         ...
                         <div class="alert alert-success ">
                             ...
                             <table class="" id="sample_2">
                                 ...
                                 <tbody>
                                 <tr>
                                     <td>refrence number :<strong><?php echo @$_GET[pass] ; ?></strong></td>
                                 </tr>
                                 
                                  <tr>
                                     <td>you can login by your idnumber and password to complete your CV</td>
                                 </tr>
                                 <tr>
                                     <td>id number : <strong><?php echo @$_GET[idnumber] ; ?> </strong> </td>
                                 </tr>
                                 <tr>
                                     <td>password : <strong><?php echo @$_GET[pass] ; ?></strong></td>
                                 </tr></tbody>
                             </table>   
