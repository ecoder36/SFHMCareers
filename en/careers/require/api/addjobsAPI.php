...
function jobsar_desc_update($id,$sub1,$desc1,$sub2,$desc2)
{
    global $tf_handle;

    $user = jobsar_get_by_id($id);
    if(!$user)
        return false ;


$fields = array();
$query = 'UPDATE `jobsar` SET ';
...
function jobsar_info_update($id,$jobname,$dept,$hours,$contract,$org,$city)
{
    global $tf_handle;
