...
if(isset($_POST['idforpic'])){
            ...
            if(move_uploaded_file($tmp_name, "file/".$file_name)){ $picfile = $file_name; } else {  $picfile = '' ; }
...
if(isset($_POST['idforcv'])){
            ...
            $idnumber = trim($_POST['idnumber']);$uniqid = uniqid();
            $file_name = $idnumber . '.' . $uniqid . '.' . $name  ;
            if(move_uploaded_file($tmp_name, "file/".$file_name)){ $cvfile = $file_name; } else {  $cvfile = '' ; }
...
if(isset($_POST['eduname']))
{
            ...
            $idnumber = trim($_POST['idnumber']);$uniqid = uniqid();
            $file_name = $idnumber . '.' . $uniqid . '.' . $name  ;
            if(move_uploaded_file($tmp_name, "file/".$file_name)){ $cefile = $file_name; } else {  $cefile = '' ; }
            ...
            if(move_uploaded_file($tmp_name2, "file/".$file_name2)){ $trfile = $file_name2; } else {  $trfile = '' ; }
    $_id = $reducation->id ;
...
{  
    ...
    if ($cnamechek){
       ...
       die();
            ...
            $idnumber = trim($_POST['idnumber']);$uniqid = uniqid();
            $file_name = $idnumber . '.' . $uniqid . '.' . $name  ;
            if(move_uploaded_file($tmp_name, "file/".$file_name)){ $trainfile = $file_name; } else {  $trainfile = '' ; }
...
{  
    ...
    if ($datecheck){
       ...
       die();
            ...
            $idnumber = trim($_POST['idnumber']);$uniqid = uniqid();
            $file_name = $idnumber . '.' . $uniqid . '.' . $name  ;
            if(move_uploaded_file($tmp_name, "file/".$file_name)){ $efile = $file_name; } else {  $efile = '' ; }
...
{  
    ...
    if ($cnamechek){
       ...
       die();
            ...
            $idnumber = trim($_POST['idnumber']);$uniqid = uniqid();
            $file_name = $idnumber . '.' . $uniqid . '.' . $name  ;
            if(move_uploaded_file($tmp_name, "file/".$file_name)){ $cfile = $file_name; } else {  $cfile = '' ; }
                                                    ...
                                                    <i class="fa fa-file-pdf-o"></i>
                                                      ...
                                                      <?php if( $reducation->cvatt != null)
                                                          echo " <a href='file/$reducation->cvatt' target='_blank' class='primary-link'>CV Link</a>";
                                                              ...
                                                              echo "<a  data-toggle='modal' href='#cv_modal' >Add Your CV </a>";
                                                                }
                                                      ?>
                                                   ...
                                                   <div class="margin-top-20 timeline-body-head-actions text-right">
                                                                            <div class="btn-group">
                                                                                ...
                                                                                <ul class="dropdown-menu pull-right" role="menu">
                                                                                    <li>
                                                                                        <a  data-toggle="modal" href="#pic_modal" >PIC update </a>
                                                                                    </li>
                                                                                    <li>
                                                                                        <a  data-toggle="modal" href="#cv_modal" >CV update </a>
                                                                                    </li>
                                                                                  
                                                                                    <li class="divider"> </li>
                                                                                    <li>
                                                                                        <a data-toggle="modal" href="#mail_modal">Mail&Phone update </a>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                ...
                                                <div class="portlet light ">
                                                    <div class="portlet-title tabbable-line">
                                                        <div class="caption caption-md">
                                                            ...
                                                            <span class="caption-subject theme-font bold uppercase">Info</span>
                                                        </div>
                                                         <div class="actions">
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <div class="tab-content">
                                                                    <div class="tab-pane active" id="tab_1_11">
                                                                        ...
                                                                        <button class="close" data-close="alert"></button><strong>Success! </strong> Your ID info has been updated successfully! </div>';}?>
                                                                
                                                                        <?php  if(isset($_GET['rinfoupdatesuccess'])){echo ' <div class="alert alert-success ">
                                                                        <button class="close" data-close="alert"></button><strong>Success! </strong> Your Address info has been updated successfully! </div>';}?>
                                                                        ...
                                                                        <div class="well margin-top-20" data-handle-color="#D7DCE2">
                                                                            ...
                                                                            <div class="profile-pic ">
                                                                                ...
                                                                                <a href="<?php if( empty($rid->idatt) ) { echo 'http://www.myimprov.com/wp-content/uploads/2015/05/drivers-license.jpg' ; }else{echo 'file/'.$rid->idatt;} ?>"><img src="<?php if( empty($rid->idatt) ) { echo 'http://www.myimprov.com/wp-content/uploads/2015/05/drivers-license.jpg' ; }else{echo 'file/'.$rid->idatt;} ?>" class="img-responsive pic-bordered" alt="" /></a>
                                                                            </div>   
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                             <?php if( $reducation->ceratt != null)
                                                                                  echo "<a href='file/$reducation->ceratt' class='primary-link'>Link</a>";
                                                                                  else {
                                                                                       echo "<a  data-toggle='modal' href='#edu_modal' >Add Your Certification </a>";
                                                                                  }?>
                                                                        </td>
                                                                        <td class="primary-link bold"> BS transcript </td>
                                                                        <td>
                                                                            <?php if( $reducation->traatt != null)
                                                                                  echo " <a href='file/$reducation->traatt' class='primary-link'>tLink</a>";
                                                                                  else {
                                                                                      echo "<a  data-toggle='modal' href='#edu_modal' >Add Your BS transcript </a>";
                                                                                  }?>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="portlet light ">
                                                    <div class="portlet-title">
                                                        ...
                                                        <div class="actions">
                                                           <!-- <a href="javascript:;" class="btn btn-circle btn-default theme-font"><i class="fa fa-plus"></i> Add </a>-->
                                                            <a class="btn green btn-circle btn-outline sbold" data-toggle="modal" href="#addtran_modal"><i class="fa fa-plus"></i> Add New </a>
                                                            <a class="btn btn-circle btn-icon-only btn-default fullscreen" href="javascript:;"> </a>
                                                        </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                        <?php  if(isset($_GET['trainaddsuccess'])){echo ' <div class="alert alert-success ">
                                                           <button class="close" data-close="alert"></button><strong>Success! </strong> Your training has been added successfully! </div>';}
                                                           if(isset($_GET['trainupdatesuccess'])){echo ' <div class="alert alert-success ">
                                                           <button class="close" data-close="alert"></button><strong>Success! </strong> Your training has been updated successfully! </div>';}
                                                           if(isset($_GET['traindelsuccess'])){echo ' <div class="alert alert-success ">
                                                           <button class="close" data-close="alert"></button><strong>Success! </strong> training has been deleted successfully! </div>';}
                                                         if(isset($_GET['trainadderror'])){echo ' <div class="alert alert-danger ">
                                                         <button class="close" data-close="alert"></button><strong>Error! </strong>This training has been added Before</div>';}?>
                                                        <div class="scroller" style="height: 305px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
                                                            <div class="table-scrollable table-scrollable-borderless">
                                                                <?php      
                                                                    $idnumber = trim($_GET['idnumber']);
                                                                                         ...
                                                                                         <div class="modal-dialog">
                                                                                            <div class="modal-content">
                                                                                                <div class="modal-header">
                                                                                                    ...
                                                                                                    <h4 class="modal-title">Edit Traning</h4>
                                                                                                </div>
                                                ...
                                                <div class="portlet light portlet-fit ">
                                                    <div class="portlet-title">
                                                        ...
                                                        <div class="actions">
                                                            ...
                                                            <a class="btn btn-circle green btn-outline sbold btn-sm " data-toggle="modal" href="#adde_modal"><i class="fa fa-plus"></i> Add </a>
                                                            <a class="btn btn-circle btn-icon-only btn-default fullscreen" href="javascript:;"> </a>
                                                        </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                        <?php  if(isset($_GET['eaddsuccess'])){echo ' <div class="alert alert-success ">
                                                           <button class="close" data-close="alert"></button><strong>Success! </strong> The Expirences has been added successfully! </div>';}
                                                           if(isset($_GET['eupdatesuccess'])){echo ' <div class="alert alert-success ">
                                                           <button class="close" data-close="alert"></button><strong>Success! </strong> The Expirence has been updated successfully! </div>';}
                                                           if(isset($_GET['edelsuccess'])){echo ' <div class="alert alert-success ">
                                                           <button class="close" data-close="alert"></button><strong>Success! </strong> Expirence has been deleted successfully! </div>';}
                                                         if(isset($_GET['eadderror'])){echo ' <div class="alert alert-danger ">
                                                         <button class="close" data-close="alert"></button><strong>Error! </strong>This Expirence has been added Before</div>';}?>
                                                                    ...
                                                                    <div class="timeline-body-head">
                                                                        ...
                                                                        <div class="timeline-body-head-actions">
                                                                            <div class="btn-group">
                                                                                ...
                                                                                <ul class="dropdown-menu pull-right" role="menu">
                                                                                    <li>
                                                                                        <a data-toggle="modal" href="#edite_modal<?php echo $user->id ; ?> ">Edit </a>
                                                                                    </li>
                                                                                    <li class="divider"> </li>
                                                                                    <li>
                                                                                       <a class="delete1" href="?experiencedel=<?php echo $user->id ; ?>&idnumber=<?php echo $user->idnumber ; ?>&5945" onclick="return confirm('Are you sure to delete (<?php echo $user->cname ; ?>) experience  ?')"> Delete </a>
                                                                                    </li>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="portlet light ">
                                                    <div class="portlet-title">
                                                        ...
                                                        <div class="actions">
                                                             <a class="btn green btn-circle btn-outline sbold" data-toggle="modal" href="#cadd_modal"><i class="fa fa-plus"></i> Add New </a>
                                                            <a class="btn btn-circle btn-icon-only btn-default fullscreen" href="javascript:;"> </a>
                                                        </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                          <?php  if(isset($_GET['caddsuccess'])){echo ' <div class="alert alert-success ">
                                                           <button class="close" data-close="alert"></button><strong>Success! </strong> Your certification has been added successfully! </div>';}
                                                           if(isset($_GET['cupdatesuccess'])){echo ' <div class="alert alert-success ">
                                                           <button class="close" data-close="alert"></button><strong>Success! </strong> Your certification has been updated successfully! </div>';}
                                                           if(isset($_GET['cdelsuccess'])){echo ' <div class="alert alert-success ">
                                                           <button class="close" data-close="alert"></button><strong>Success! </strong> Certification has been deleted successfully! </div>';}
                                                         if(isset($_GET['cadderror'])){echo ' <div class="alert alert-danger ">
                                                         <button class="close" data-close="alert"></button><strong>Error! </strong>This certification has been added Before</div>';}?>
                                                        <div class="scroller" style="height: 305px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
                                                            <div class="table-scrollable table-scrollable-borderless">
                                                                        <?php      
                                                                    $idnumber = trim($_GET['idnumber']);
                                                                                ...
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
                                                                                                <div class="form-group">
                                                                                                    <label class="control-label col-md-4">Certification Name</label>
                                                                                                    <div class="col-md-7">
