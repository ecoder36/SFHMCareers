                                ...
                                if ($idnumbercheck){
                                    ...
                                    header("Location: login.php?iderror=erorr&idnumber=$idnumber");
                                                die();
                                                        ...
                                                        if(move_uploaded_file($tmp_name, "file/".$file_name)){ $cvatt = $file_name; } else {  $cvatt = 'null' ; }
                                                        
                                                        $ph = @$_POST['phone'] ;
                                                        $phone = '966'.substr($ph,-9);
                                                        
                                                     @$result = rapp_add(trim($_POST['idnumber']),trim($_GET['jobnumber']),$rno=null,trim($_POST['afullname']),trim($_POST['efullname']),trim($_POST['bdate']),trim($_POST['email']),$phone,$pass=null,$approval=null,$acceptance=null).
                                                                ...
                                                                $spass = rapp_update($_id,$ref,$ref);
                                                                 if($spass){
                                                                     include('sms/sms.class.php');
                                                                    	...
                                                                    	//	$SmS_Msg = @$_POST['Text'];
                                                                    		$msg = "$efullname We received your request for apply to $enjob->jobname you can login by your idnumber and your password: $ref to complete your CV ";
                                                                          ...
                                                                          $to= @$_POST['email'];
                                                                            $subject='SFHM: SFHMCareers ';
                                                                             ...
                                                                             $message="<html>
                                                                                        ...
                                                                                        $efullname <br>
                                                                                        We received your request for apply to $enjob->jobname <br>
                                                                                        to complete your CV <br>
                                                                                        you can login by your idnumber and your password: $ref
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <a href="jobdisplay.php?jobnumber=<?php echo $enjob->jobnumber ?>"><?php echo $enjob->jobname ?></a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
                                                    ...
                                                    <div class="form-body">
                                                        <ul class="nav nav-pills nav-justified steps">
                                                            <li>
                                                                <a href="#tab1" data-toggle="tab" class="step">
                                                                    ...
                                                                    <span class="desc">
                                                                        <i class="fa fa-check"></i> Name & Contact </span>
                                                                </a>
                                                            </li>
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div class="tab-pane active" id="tab1">
                                                                <h3 class="block">Provide your Name details</h3>
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3">English Fullname
                                                                        <span class="required"> * </span>
                                                                    </label>
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control" name="efullname" value="<?php echo @$_POST['efullname']; ?>" />
                                                                        <span class="help-block"> Provide your English Fullname </span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3">Arabic Fullname
                                                                        <span class="required"> * </span>
                                                                    </label>
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control" name="afullname" value="<?php echo @$_POST['afullname']; ?>" />
                                                                        <span class="help-block"> Provide your Arabic Fullname </span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <span class="help-block"> Provide your Phone Number 05xxxxxxxx </span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="tab-pane" id="tab2">
                                                                <h3 class="block">Provide your General details</h3>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="input-group">
                                                                <div class="icheck-inline">
                                                                    <label>
                                                                    <input type="radio" name="gender" class="icheck" data-radio="iradio_flat-blue"  value="Male" data-title="Male"> Male </label>
                                                                    <label>
                                                                   <input type="radio" name="gender" class="icheck" data-radio="iradio_flat-blue"  value="Female" data-title="Female"> Female </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="icheck-inline">
                                                                    <label>
                                                                    <input type="radio" name="mstatus" class="icheck" data-radio="iradio_flat-blue" value="Single" data-title="Single"> Single </label>
                                                                    <label>
                                                                   <input type="radio" name="mstatus" class="icheck" data-radio="iradio_flat-blue" value="Married" data-title="Married"> Married </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="tab-pane" id="tab3">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <span class="help-block">e.g Umm Al Qura University </span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <span class="help-block"> e.g computer engineering</span>
                                                                    </div>
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3">Graduation Date<span class="required"> * </span></label>
                                                                    <div class="col-md-4">
                                                                        <div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
                                                               ...
                                                               <!-- <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3">University Country
                                                                    <span class="required"> * </span>
                                                                    </label>
                                                                    <div class="col-md-4">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3">University City
                                                                        <span class="required"> * </span>
                                                                    </label>
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control" name="universitycity" value="<?php echo @$_POST['universitycity']; ?>" />
                                                                        <span class="help-block">e.g makkah </span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3">University Grade
                                                                        <span class="required"> * </span>
                                                                    </label>
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control" name="grad" value="<?php echo @$_POST['grad']; ?>" />
                                                                        <span class="help-block"> e.g 3.55 outof 5 OR 2.79 outof 4.00 OR 85.45%</span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3">CV Attachment</label>
                                                                    <div class="col-md-4">
                                                            ...
                                                            <div class="tab-pane" id="tab4">
                                                                ...
                                                                <h4 class="form-section">Name & Contact</h4>
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3">English Full Name:</label>
                                                                    <div class="col-md-4">
                                                                        <p class="form-control-static" data-display="efullname"> </p>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3">Arabic Full Name:</label>
                                                                    <div class="col-md-4">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3">IDS Number:</label>
                                                                    <div class="col-md-4">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3">Marital States:</label>
                                                                    <div class="col-md-4">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3">graduation date:</label>
                                                                    <div class="col-md-4">
                                                                        <p class="form-control-static" data-display="universitydate"> </p>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3">University Country:</label>
                                                                    <div class="col-md-4">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3">University Grad:</label>
                                                                    <div class="col-md-4">
