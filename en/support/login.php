...
if(isset($_POST['username']) && (isset($_POST['password'])))
{
        ...
        header("Location: ?user=No User OR Wrong User Info.&uname=$uname");
        ...
        if($user->eid == '1'){
            ...
            header("Location: ?password=Wrong Password.&uname=$uname");
            ...
            header("Location: ?status=User Blocked&uname=$uname");
        }
                                            ...
                                            <div class="alert alert-danger display-hide">
                                                <button class="close" data-close="alert"></button> You have some form errors. Please check below. </div>
                                                   <?php    if(isset($_GET['user'])){echo '<div class="alert alert-danger ">
                                                    ...
                                                    <button class="close" data-close="alert"></button><strong>Error! </strong> '.$_GET['status'].'</div>';}?>
