...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Metronic | Dropzone File Upload</title>
                        ...
                        <div class="page-content-inner">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <form id="upload_form" enctype="multipart/form-data" method="post" action="upload.php" class="dropzone dropzone-file-area" style="width: 500px; margin-top: 50px;">
...
<![endif]-->
        ...
        <script src="formdrop.js" type="text/javascript"></script>
