...
if(@$error) {
    	...
    	{
             @$result = form_add($_POST['name'],$_POST['pname'],$_POST['snap'],$link);
             tinyf_db_close();
             if($result)
                 {
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <?php
                                        ...
                                        <button class="close" data-close="alert"></button><strong>Error! </strong> not save </div>';}
                                        ...
                                        <div class="portlet-title">
                                            ...
                                            <div class="actions">
                                                <form class="btn" method="post" >
                                                          ...
                                                          <button type="submit" class="btn btn-circle btn-sm red-sunglo" > <i class="fa fa-pencil"></i> save  </button>
                                                </form>
