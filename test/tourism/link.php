                                ...
                                <div class="col-md-12">
                                    <?php
                                     if   (isset($_GET['done'] )  )  {echo '<div class="alert alert-success ">
                                        <button class="close" data-close="alert"></button><strong> تم حفظ بيانات التقرير بنجاح </strong>  </div>';}?>
...
@font-face {
  font-family: 'Regulara4';
  src: url('UniversNextArabic-Regular.eot?#iefix') format('embedded-opentype'),  url('UniversNextArabic-Regular.woff') format('woff'), url('UniversNextArabic-Regular.ttf')  format('truetype'), url('UniversNextArabic-Regular.svg#UniversNextArabic-Regular') format('svg');
  font-weight: normal;
  font-style: normal;
}
                  ...
                  <span style="font-family: 'Regulara1';">&nbsp;</span>
                                 <span style="font-family: 'Regulara4';">&nbsp;</span>
            <script> 
